...
export default function CancellationPolicyPage() {
  ...
  const content = (legalSettings as any)?.cancellationPolicy || 'Cancellation Policy is currently being updated.';

  return (
    <div className="min-h-screen bg-slate-50 py-12 md:py-24">
      <div className="max-w-4xl mx-auto px-4">
        <h1 className="text-4xl font-black text-slate-900 mb-8">Cancellation Policy</h1>
